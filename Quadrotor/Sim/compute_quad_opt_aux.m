function u_aux = compute_quad_opt_aux(X,X_dot,E,...
                            W_fun,W_yaw,f_fun,B_fun,u_nom,lambda)
...
W_start = blkdiag(W_fun.W_eval(w_poly(:,1)),W_yaw);
W_end = blkdiag(W_fun.W_eval(w_poly(:,K_e)),W_yaw);
