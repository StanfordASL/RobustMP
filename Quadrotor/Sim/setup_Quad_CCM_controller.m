function [geo_Prob,cntrl_info] = setup_Quad_CCM_controller(n,m,geodesic_N,...
                                                      W_fun,dW_fun,n_W,W_yaw,f_fun,B_fun,...
                                                      lambda,x_0,u_0,x)
...
%geodesic defined only over xc(1:9)
[geo_Prob,T_e,T_dot_e] = setup_geodesic_calc(n-1,geodesic_N,W_fun,dW_fun,n_W);
...
tic
[J_opt,converged_geo,geo_Prob,cntrl_info,u_aux]  = compute_Quad_CCM_controller(geo_Prob,cntrl_info,x_0,u_0,x);
toc;
